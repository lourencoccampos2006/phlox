...
import { summariseDay, type DaySummary, type AttRow } from '@/lib/diaDaFamilia'
...
// O resumo do dia vive em lib/diaDaFamilia.ts — partilhado com o email do
// fim do dia (app/api/cron/resumo-familia), para o dia ser contado da mesma
// maneira quando a família abre o portal e quando não abre.
