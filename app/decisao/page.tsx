...
const CASE_CONFIGS: CaseConfig[] = [
  // ── Cardiologia ───────────────────────────────────────────────────────
  { id: 'chf_decompensation', title: 'Dispneia aguda no idoso', specialty: 'Cardiologia', difficulty: 'intern', difficultyLabel: 'Interno', description: 'Homem 72 anos, FA, dispneia progressiva, ortopneia, edemas. SpO2 88%. Diuresar? IECA? Ventilação?', color: '#dc2626', estimated_minutes: 15 },
  { id: 'stemi_anterior', title: 'STEMI anterior extenso', specialty: 'Cardiologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Homem 58 anos, dor torácica há 90 min, supra-ST V2-V6, troponina 1850. Hemodinâmica a 35 min — fibrinólise ou aguarda?', color: '#dc2626', estimated_minutes: 18 },
  { id: 'nstemi', title: 'NSTEMI no idoso diabético', specialty: 'Cardiologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Mulher 67 anos, DM2, dor torácica intermitente, subdesnível ST, troponina sobe. GRACE 142. Quão urgente é o cateterismo?', color: '#dc2626', estimated_minutes: 18 },
  { id: 'aortic_dissection', title: 'Dor torácica "rasgada" com hipertensão', specialty: 'Cardiologia', difficulty: 'specialist', difficultyLabel: 'Especialista', description: 'Homem 56 anos, dor súbita irradiando dorso, diferencial TA 50 mmHg entre braços, sopro diastólico novo. Beta-bloquear ou alfa?', color: '#7f1d1d', estimated_minutes: 20 },
  { id: 'pericarditis_tamponade', title: 'Pericardite com tamponamento iminente', specialty: 'Cardiologia', difficulty: 'specialist', difficultyLabel: 'Especialista', description: 'Mulher 32 anos, dor pleurítica, atrito, pulso paradoxal 18, colapso AD na eco. Pericardiocentese ou aguardar?', color: '#dc2626', estimated_minutes: 18 },
  { id: 'bradyarrhythmia_block', title: 'BAV completo com síncope', specialty: 'Cardiologia', difficulty: 'intern', difficultyLabel: 'Interno', description: 'Mulher 78 anos em betabloqueante + digoxina, síncope, FC 32, dissociação AV. Atropina? Pacing? Suspender fármacos?', color: '#dc2626', estimated_minutes: 15 },
  // ── Pulmonar ─────────────────────────────────────────────────────────
  { id: 'copd_exacerbation', title: 'Exacerbação grave de DPOC', specialty: 'Pneumologia', difficulty: 'intern', difficultyLabel: 'Interno', description: 'GOLD 3, esputo purulento, SpO2 84%, pH 7.30 com pCO2 65. Quanto O2? VNI? Antibiótico empírico?', color: '#b45309', estimated_minutes: 18 },
  { id: 'asthma_severe', title: 'Crise asmática quase fatal', specialty: 'Pneumologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Jovem 24 anos, frases incompletas, peito silencioso, PEF 25%. Beta-2 contínuo? Magnésio? Quando intubar?', color: '#dc2626', estimated_minutes: 16 },
  { id: 'pulmonary_embolism', title: 'TEP submaciço pós-cirurgia', specialty: 'Pneumologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Mulher 52 anos, pós-op, dispneia súbita, troponina+. AngioTAC positiva. Anticoagular? Trombolisar?', color: '#1d4ed8', estimated_minutes: 18 },
  { id: 'pneumothorax_tension', title: 'Pneumotórax hipertensivo', specialty: 'Pneumologia', difficulty: 'intern', difficultyLabel: 'Interno', description: 'Magro 28 anos, dor torácica súbita, desvio traqueal, hipotenso. Drenar primeiro, imagem depois.', color: '#dc2626', estimated_minutes: 10 },
  { id: 'pneumonia_abx', title: 'Pneumonia sem resposta ao antibiótico', specialty: 'Infecciologia', difficulty: 'specialist', difficultyLabel: 'Especialista', description: 'Mulher 55 anos, D3 amoxicilina sem melhoria. PCR sobe. Escalar para piperacilina-tazobactam? Atípicos?', color: '#0d6e42', estimated_minutes: 25 },
  // ── Sépsis / Infeções ───────────────────────────────────────────────
  { id: 'sepsis_antibiotics', title: 'Sépsis nosocomial — hora dourada', specialty: 'Medicina Interna', difficulty: 'intern', difficultyLabel: 'Interno', description: 'Doente internada com novo pico febril, hipotensão, leucocitose. Antibiótico em <1h. Largo espectro empírico ou dirigido?', color: '#b45309', estimated_minutes: 20 },
  { id: 'meningitis_bacterial', title: 'Meningite com púrpura', specialty: 'Neurologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Universitário 22 anos, febre, rigidez, petéquias, GCS 13. Antibiótico antes ou depois da PL? Corticoides?', color: '#7f1d1d', estimated_minutes: 18 },
  { id: 'neutropenic_fever', title: 'Neutropenia febril no oncológico', specialty: 'Infecciologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'LMA D+8, febre 38.7°C, neutrófilos 280. Antibiótico empírico imediato — qual? Mocs do cateter?', color: '#0d6e42', estimated_minutes: 18 },
  { id: 'tropical_malaria', title: 'Febre tropical importada', specialty: 'Infecciologia', difficulty: 'specialist', difficultyLabel: 'Especialista', description: 'Regressou de África há 5 dias sem profilaxia. Falciparum 4%. Hipoglicémia. Artesunato IV ou oral?', color: '#9a3412', estimated_minutes: 20 },
  { id: 'urinary_pyelonephritis', title: 'Pielonefrite aguda complicada', specialty: 'Urologia', difficulty: 'intern', difficultyLabel: 'Interno', description: 'Diabética 68 anos, dor lombar, febre, hipotensão, dilatação pielocalicial. Antibiótico + drenagem?', color: '#b45309', estimated_minutes: 18 },
  // ── Endócrino / Metabólico ──────────────────────────────────────────
  { id: 'dm_ketoacidosis', title: 'Cetoacidose diabética grave', specialty: 'Endocrinologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'DM1, vómitos, glicémia 450, pH 7.21, K+ 3.2. Repor volume? Insulina? Quando começar K+?', color: '#7c3aed', estimated_minutes: 20 },
  { id: 'hyperosmolar_state', title: 'Estado hiperosmolar', specialty: 'Endocrinologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'DM2 78 anos, glicémia 920, Na 158, osm 360, confuso. Soros, ritmo de descida, insulina.', color: '#7c3aed', estimated_minutes: 22 },
  { id: 'thyroid_storm', title: 'Tempestade tiroideia', specialty: 'Endocrinologia', difficulty: 'specialist', difficultyLabel: 'Especialista', description: 'Graves descompensada, febre 39.7°C, FA 158, ICC. Antitiroideu, betabloqueante, iodo — qual ordem?', color: '#7c3aed', estimated_minutes: 22 },
  { id: 'adrenal_crisis', title: 'Crise addisoniana', specialty: 'Endocrinologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'DAI sem cortisol há 4 dias, hipotensão refratária, hipoNa, hipoglicémia. Hidrocortisona já — sim, mas como?', color: '#7c3aed', estimated_minutes: 18 },
  { id: 'hyperkalemia', title: 'Hipercaliémia com alterações ECG', specialty: 'Nefrologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'DRC4, K+ 7.2, T apiculadas, QRS largo. Estabilizar membrana? Translocar? Remover? Ordem.', color: '#b45309', estimated_minutes: 18 },
  { id: 'hyponatremia_severe', title: 'Hiponatremia com convulsão', specialty: 'Nefrologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Idosa em tiazida + ISRS, Na 112, convulsão. Sódio hipertónico — quanto? Risco de mielinólise.', color: '#b45309', estimated_minutes: 18 },
  // ── Neurologia ───────────────────────────────────────────────────────
  { id: 'ischemic_stroke', title: 'AVC isquémico em janela', specialty: 'Neurologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'NIHSS 14, ASPECTS 9, TA 198/108. Trombólise? Trombectomia? Controlo de TA antes ou depois?', color: '#0d6e42', estimated_minutes: 20 },
  { id: 'hemorrhagic_stroke', title: 'AVC hemorrágico extenso', specialty: 'Neurologia', difficulty: 'resident', difficultyLabel: 'Residente', description: '28 mL putaminal, GCS 11, TA 215/120. Quanto baixar a TA? Indicação cirúrgica?', color: '#7f1d1d', estimated_minutes: 18 },
  { id: 'status_epilepticus', title: 'Status epilépticus', specialty: 'Neurologia', difficulty: 'intern', difficultyLabel: 'Interno', description: 'Crises consecutivas há 8 min. Benzodiazepina dose certa? E se falha? Quando intubar?', color: '#dc2626', estimated_minutes: 16 },
  { id: 'guillain_barre', title: 'Tetraparesia ascendente', specialty: 'Neurologia', difficulty: 'specialist', difficultyLabel: 'Especialista', description: 'Pós-GE, fraqueza ascendente, capacidade vital 1.2L. IVIG ou plasmaferese? Quando intubar?', color: '#0d6e42', estimated_minutes: 18 },
  { id: 'meningitis_viral', title: 'Meningoencefalite herpética', specialty: 'Neurologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Alteração comportamento, crise focal, hiperintensidade temporal. Aciclovir empírico já?', color: '#0d6e42', estimated_minutes: 18 },
  // ── GI / Hepato ──────────────────────────────────────────────────────
  { id: 'anticoag_bleeding', title: 'Hemorragia digestiva sob varfarina', specialty: 'Gastroenterologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Hematemese, INR 8.2, Hb 8.2. Reverter como? CCP ou plasma? Endoscopia urgente?', color: '#1d4ed8', estimated_minutes: 15 },
  { id: 'acute_pancreatitis', title: 'Pancreatite aguda grave', specialty: 'Gastroenterologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Litíase, dor 18h, lipase 1850, BISAP 4. Reposição volémica agressiva? Antibiótico profilático ou não?', color: '#7c3aed', estimated_minutes: 22 },
  { id: 'perforated_ulcer', title: 'Úlcera perfurada com peritonite', specialty: 'Cirurgia Geral', difficulty: 'resident', difficultyLabel: 'Residente', description: 'AINEs, abdómen em tábua, pneumoperitoneu. Cirurgia já — quando o doente está suficientemente estável?', color: '#7f1d1d', estimated_minutes: 18 },
  { id: 'hepatic_encephalopathy', title: 'Encefalopatia hepática grau III', specialty: 'Gastroenterologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Cirrose, asterixis, sonolento, obstipação. Lactulose, rifaximina, identificar o precipitante.', color: '#7c3aed', estimated_minutes: 18 },
  { id: 'cholangitis', title: 'Colangite com choque', specialty: 'Gastroenterologia', difficulty: 'specialist', difficultyLabel: 'Especialista', description: 'Charcot + Reynolds, bilirrubina 8.2, cálculo coledociano. CPRE quando? Antibiótico antes.', color: '#7f1d1d', estimated_minutes: 20 },
  // ── Toxicologia ──────────────────────────────────────────────────────
  { id: 'opioid_overdose', title: 'Depressão respiratória por opioides', specialty: 'Toxicologia', difficulty: 'intern', difficultyLabel: 'Interno', description: 'Oncológico em morfina LP, FR 6, miose. Naloxona — dose, via, repetir? Cuidado com a tempestade adrenérgica.', color: '#1d4ed8', estimated_minutes: 14 },
  { id: 'paracetamol_overdose', title: 'Intoxicação por paracetamol', specialty: 'Toxicologia', difficulty: 'resident', difficultyLabel: 'Residente', description: '30 cp há 10h, nomograma na linha. N-acetilcisteína IV — quando começa, dose total. Lista de transplante?', color: '#1d4ed8', estimated_minutes: 18 },
  { id: 'tca_overdose', title: 'Overdose de tricíclicos com QRS largo', specialty: 'Toxicologia', difficulty: 'specialist', difficultyLabel: 'Especialista', description: 'Amitriptilina, QRS 0.14s, R em aVR. Bicarbonato — quando, quanto? Antiarrítmico?', color: '#1d4ed8', estimated_minutes: 18 },
  { id: 'bb_overdose', title: 'Intoxicação por betabloqueante', specialty: 'Toxicologia', difficulty: 'specialist', difficultyLabel: 'Especialista', description: 'Propranolol 40x40cp, FC 35, TA 75/40, hipoglicémia. Glucagon? Insulina-glicose? Lípidos?', color: '#1d4ed8', estimated_minutes: 18 },
  { id: 'organophosphate', title: 'Intoxicação por organofosforados', specialty: 'Toxicologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Agricultor com SLUDGE-Killer Bs. Atropina em titulação — alvo. Pralidoxima? Descontaminação primeiro?', color: '#1d4ed8', estimated_minutes: 18 },
  // ── Hematologia / Oncologia ────────────────────────────────────────
  { id: 'tumor_lysis', title: 'Síndrome de lise tumoral', specialty: 'Hematologia', difficulty: 'specialist', difficultyLabel: 'Especialista', description: 'LBA pós-quimio, K 6.4, P 9.8, Ca 7.2. Hidratação, rasburicase ou alopurinol? Hemodiálise?', color: '#9333ea', estimated_minutes: 18 },
  { id: 'ttp_microangiopathy', title: 'PTT com esquizócitos', specialty: 'Hematologia', difficulty: 'specialist', difficultyLabel: 'Especialista', description: 'Trombocitopenia, anemia hemolítica, neuro, febre, renal. Plasmaferese urgente — começar antes do ADAMTS13?', color: '#9333ea', estimated_minutes: 20 },
  // ── Trauma ────────────────────────────────────────────────────────────
  { id: 'head_trauma_severe', title: 'TCE grave com sinais de herniação', specialty: 'Neurocirurgia', difficulty: 'specialist', difficultyLabel: 'Especialista', description: 'GCS 7, pupila anisocórica, hematoma subdural 14mm, desvio 8mm. Manitol/salino hipertónico? Neurocirurgia urgente.', color: '#7f1d1d', estimated_minutes: 18 },
  { id: 'trauma_polytrauma', title: 'Politraumatismo grave', specialty: 'Cirurgia Geral', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Atropelamento, FAST positivo, fractura aberta. Damage control? Ácido tranexâmico? Bloco já?', color: '#7f1d1d', estimated_minutes: 20 },
  // ── Obstetrícia ───────────────────────────────────────────────────────
  { id: 'eclampsia', title: 'Eclâmpsia às 34 semanas', specialty: 'Obstetrícia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Convulsão na pré-eclâmptica. Sulfato de magnésio — dose, monitorização. Terminar a gravidez?', color: '#be185d', estimated_minutes: 18 },
  { id: 'pph_postpartum', title: 'Hemorragia pós-parto atónica', specialty: 'Obstetrícia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Útero atónico, 1500 mL perdidos. Massagem, oxitocina, ergot, prostaglandinas, balão — escada.', color: '#be185d', estimated_minutes: 16 },
  // ── Pediatria ─────────────────────────────────────────────────────────
  { id: 'pediatric_bronchiolitis', title: 'Bronquiolite grave em lactente', specialty: 'Pediatria', difficulty: 'intern', difficultyLabel: 'Interno', description: 'Lactente 4m, ex-prematuro, FR 72, SpO2 88%, apneias. CNAF? VNI? Quando intubar?', color: '#0891b2', estimated_minutes: 16 },
  { id: 'pediatric_febrile_seizure', title: 'Convulsão febril complicada', specialty: 'Pediatria', difficulty: 'intern', difficultyLabel: 'Interno', description: '18 meses, crise prolongada com otite. Antibiótico? PL? EEG?', color: '#0891b2', estimated_minutes: 14 },
  { id: 'pediatric_intussusception', title: 'Invaginação intestinal', specialty: 'Pediatria', difficulty: 'resident', difficultyLabel: 'Residente', description: 'Lactente 9m com cólica e "geleia de morango". Redução hidrostática? Cirurgia se falha.', color: '#0891b2', estimated_minutes: 16 },
  // ── Comportamental / Iatrogenia ────────────────────────────────────
  { id: 'serotonin_syndrome', title: 'Síndrome serotoninérgica', specialty: 'Toxicologia', difficulty: 'resident', difficultyLabel: 'Residente', description: 'ISRS + tramadol, hiperreflexia, clónus, febre 39.4. Suspender tudo, ciproheptadina, refrigerar.', color: '#1d4ed8', estimated_minutes: 16 },
  { id: 'nms', title: 'Síndrome neuroléptico maligno', specialty: 'Psiquiatria', difficulty: 'specialist', difficultyLabel: 'Especialista', description: 'Haloperidol depot, rigidez tubo de chumbo, T 40.1, CK 18500. Bromocriptina? Dantroleno? Rabdomiolise.', color: '#7c3aed', estimated_minutes: 18 },
  // ── Geriatria / Polimedicação ──────────────────────────────────────
  { id: 'polypharmacy_elderly', title: 'Queda no doente polimedicado', specialty: 'Farmácia Clínica', difficulty: 'intern', difficultyLabel: 'Interno', description: 'Homem 84 anos, 11 medicamentos, hipotensão ortostática. Que medicamentos desprescrever? STOPP/START.', color: '#0891b2', estimated_minutes: 20 },
  { id: 'delirium_hyperactive', title: 'Delirium hiperactivo no idoso', specialty: 'Geriatria', difficulty: 'intern', difficultyLabel: 'Interno', description: 'Pós-pneumonia, agitação, alucinações, globo vesical. Identificar precipitantes, não-farmacológico primeiro.', color: '#0891b2', estimated_minutes: 16 },
  { id: 'warfarin_inr_elevation', title: 'INR 9.5 sem hemorragia', specialty: 'Farmácia Clínica', difficulty: 'intern', difficultyLabel: 'Interno', description: 'Pós ciprofloxacina. Suspender, vit K oral baixa-dose? Internar?', color: '#0891b2', estimated_minutes: 12 },
  // ── Alergia ──────────────────────────────────────────────────────────
  { id: 'anaphylaxis', title: 'Anafilaxia pós-antibiótico', specialty: 'Urgência', difficulty: 'intern', difficultyLabel: 'Interno', description: 'Mulher 28 anos, edema labial e estridor após amoxicilina. TA 78/40. Adrenalina IM já — depois.', color: '#dc2626', estimated_minutes: 12 },
]
