...
const TOOLS = [
  {
    ...
    desc: 'Cola a lista de medicamentos de qualquer doente. Recebe análise completa de interações, problemas e recomendações — em linguagem simples ou técnica. Sem conta.',
    badge: 'Para todos',
    badgeColor: '#166534',
    badgeBg: '#dcfce7',
  },
  {
    ...
    desc: 'Protocolos de diluição, velocidades de perfusão, estabilidade e calculadora integrada para 10 fármacos IV. Para enfermeiros e farmacêuticos hospitalares.',
    badge: 'Enfermeiros',
    badgeColor: '#0369a1',
    badgeBg: '#f0f9ff',
  },
  ...
  },
  {
    ...
    code: '03',
    title: 'Modo Exame',
    desc: 'Simulação real de exame de Farmacologia Clínica. Timer, 40 perguntas, análise de pontos fracos. Plano Student.',
    badge: 'Student',
    badgeColor: '#7c3aed',
    badgeBg: '#ede9fe',
  },
  ...
  },
  {
    ...
    desc: 'Aptidão para conduzir, doping no desporto, gravidez, interação com álcool e critérios Beers em idosos.',
    badge: 'Novo',
    badgeColor: '#166534',
    badgeBg: '#dcfce7',
  },
