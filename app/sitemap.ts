...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/generics`, lastModified: now, changeFrequency: 'weekly', priority: 0.85 },
    ...
    { url: `${BASE_URL}/disease`,                 lastModified: now, changeFrequency: 'weekly',  priority: 0.85 },
    { url: `${BASE_URL}/diary`, lastModified: now, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${BASE_URL}/consult-prep`, lastModified: now, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${BASE_URL}/shift`, lastModified: now, changeFrequency: 'weekly', priority: 0.85 },
