      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '40px 40px 80px' }}>
        ...
        <div style={{ background: 'white', border: '1px solid var(--border)', borderRadius: 6, padding: '28px 32px', marginBottom: 32 }}>
          <div style={{ marginBottom: 20 }}>
            ...
            <p style={{ fontSize: 13, color: 'var(--ink-4)', lineHeight: 1.5, margin: 0 }}>Dados clínicos directos da FDA. Introduz o nome DCI em inglês para melhores resultados.</p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: 24, alignItems: 'start' }}>
                  ...
                  return (
                    <div key={key} style={{ borderBottom: i < SECTIONS.length - 1 ? '1px solid var(--border)' : 'none' }}>
                      <button onClick={() => toggle(key)}
                        style={{ width: '100%', display: 'grid', gridTemplateColumns: '1fr auto', alignItems: 'center', padding: '16px 24px', background: 'none', border: 'none', cursor: 'pointer', textAlign: 'left', gap: 16 }}>
                        <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div style={{ background: 'white', border: '1px solid var(--border)', borderRadius: 6, padding: '20px' }}>
                ...
                <Link href="/interactions" style={{ display: 'block', background: 'var(--green)', color: 'white', textDecoration: 'none', borderRadius: 4, padding: '10px 14px', fontSize: 13, fontWeight: 600, textAlign: 'center', marginBottom: 8 }}>
              ...
              {result.top_adverse_events?.length > 0 && (
                <div style={{ background: 'white', border: '1px solid var(--border)', borderRadius: 6, padding: '20px' }}>
                  ...
                  <div style={{ fontFamily: 'var(--font-mono)', fontSize: 10, color: 'var(--ink-4)', marginBottom: 12, lineHeight: 1.5 }}>Dados de farmacovigilância FDA. Por frequência de reporte.</div>
              ...
              <div style={{ background: 'var(--bg-2)', border: '1px solid var(--border)', borderRadius: 6, padding: '16px' }}>
                ...
                <p style={{ fontSize: 11, color: 'var(--ink-4)', lineHeight: 1.6, margin: 0 }}>Informação educacional baseada em dados OpenFDA. Não substitui o RCM oficial nem aconselhamento profissional.</p>
              </div>
            </div>
          </div>
        )}
