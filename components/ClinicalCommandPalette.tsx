...
const DESTINATIONS: Dest[] = [
  ...
  { label: 'Equipa & Escalas',           href: '/equipa?tab=escalas', group: 'Gestão', keywords: 'turnos equipa staff funcionarios' },
  ...
  { label: 'Indicadores & Desempenho',    href: '/painel-dono?tab=desempenho', group: 'Gestão', keywords: 'indicadores desempenho analytics receita vendas tendencia kpi estatistica relatorio retorno' },
  ...
  { label: 'Insights & Benchmarks (Pro)', href: '/painel-dono?tab=comparar', group: 'Gestão', keywords: 'insights benchmarks comparar pool mediana percentil anonymized analytics setor' },
  ...
  { label: 'Sinais vitais — TA, peso, hidratação', href: '/vitals', group: 'Conta',    keywords: 'agua hidratacao copo litros meta dia peso kg balanca grafico tendencia mensal vitais imc' },
  { label: 'Calculadoras clínicas',       href: '/calculos',      group: 'Clínico',    keywords: 'calc essenciais crcl egfr ckdepi imc bsa cha2ds2 hasbled qsofa news2 wells meld glasgow centor abcd2 padua osm fena maddrey light bishop' },
...
const QUICK_ACTIONS: Dest[] = [
  ...
  { label: 'Marcar turno',        href: '/equipa?tab=escalas', group: 'Ações', keywords: 'escala equipa' },
]
