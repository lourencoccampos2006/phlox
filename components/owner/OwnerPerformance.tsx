...
// Indicadores & Desempenho — era a página /roi. Fundido em /painel-dono como
// separador "Desempenho": receita, atividade e tendências reais dos últimos 6
// meses, adaptado por tipo de instituição. Lógica e dados inalterados.
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 18, gap: 12, flexWrap: 'wrap' }}>
        <p style={{ fontSize: 13, color: 'var(--ink-4)', margin: 0 }}>Os teus números reais dos últimos 6 meses — {isRevenue ? 'receita, atividade' : 'operação, qualidade'} e tendências.</p>
