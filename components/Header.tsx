          ...
          {loading ? (
            ...
            <div style={{ position: 'relative' }}>
              ...
              >
                ...
                <span style={{ fontSize: 13, color: 'var(--ink-2)', maxWidth: 100, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                  {user.name.split(' ')[0]}
                </span>
                  ...
                  <div style={{
                    ...
                    <div style={{ padding: '14px 16px', borderBottom: '1px solid var(--border)', background: 'var(--bg-2)' }}>
                      ...
                      <div style={{
                        ...
                        border: `1px solid ${user.plan === 'free' ? 'var(--border)' : '#9ae6b4'}`,
                        borderRadius: 3,
                        padding: '2px 8px',
                        fontSize: 10,
                        ...
                        {user.plan === 'free' ? 'Gratuito' : user.plan === 'student' ? 'Student' : 'Pro'}
                      </div>
                    </div>
                    ...
                    {[
                      ...
                      { href: '/dashboard?tab=history', label: 'Histórico de pesquisas', icon: '🕐' },
