...
const NAV: Record<ExperienceMode, { section?: string; href: string; icon: string; label: string; badge?: string }[][]> = {
  ...
  clinical: [
    [
      { href: '/dashboard', icon: '⬛', label: 'Início' },
      { href: '/turno',     icon: '🏥', label: 'Turno',   badge: 'principal' },
    ...
    [
      ...
      { href: '/optimizer',    icon: '⚡', label: 'Otimizar' },
      { href: '/calculators',  icon: '🧮', label: 'Calculadoras' },
      { href: '/adr-report',   icon: '⚠️', label: 'Notif. RAM' },
    ],
    [
      { href: '/protocol',     icon: '📚', label: 'Protocolos' },
      { href: '/med-review',   icon: '🔬', label: 'Rev. Medicação' },
