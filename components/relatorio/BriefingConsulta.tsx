...
// Briefing Clínico de Consulta — era a página /briefing. Fundido em /relatorio
// como separador "Briefing de Consulta" (Pro). Lógica e gate de plano (cliente +
// /api/briefing) inalterados.
...
function UpgradeGate() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '50vh', padding: '0 20px', textAlign: 'center' }}>
...
export default function BriefingConsulta() {
    ...
    <div className="interactions-layout">
      <div className="sticky-panel">
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: 20, color: 'var(--ink)', marginBottom: 6 }}>Briefing Clínico</h2>
