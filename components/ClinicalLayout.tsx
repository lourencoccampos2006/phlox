...
const ICONS = {
  ...
  webhook:   <><path d="M18 16.5a4 4 0 1 0-3-6.6"/><path d="M6 9a4 4 0 0 0 1 7.5"/><circle cx="12" cy="5" r="2"/><circle cx="5" cy="17" r="2"/><circle cx="19" cy="17" r="2"/></>,
...
const PHARMACY: NavSection[] = [
  ...
  { title: 'Legal & integrações', items: [
    { href: '/conformidade', label: 'Conformidade', icon: 'shield', badge: true },
    { href: '/consentimentos', label: 'Consentimentos', icon: 'consent', badge: true },
    { href: '/webhooks', label: 'Webhooks & API', icon: 'webhook', badge: true },
    { href: '/documentos', label: 'Documentos', icon: 'docs' },
  ]},
]
