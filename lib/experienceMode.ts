...
export const ROUTE_GROUPS: Record<ExperienceMode, RouteGroup[]> = {
  ...
  clinical: [
    ...
    },
    {
      ...
      color: '#0f766e',
      tools: [
        { href: '/oracle',      label: 'Oracle — Consulta AI',    sub: 'Avaliação SOAP completa com plano · PCNE v9.1', badge: 'Novo' },
        { href: '/optimizer',   label: 'Otimizar Prescrição',     sub: 'Genéricos · segurança · monitorização · doses', badge: 'Novo' },
    ...
    },
    {
      ...
      tools: [
        ...
        { href: '/integracoes',  label: 'Integrações',              sub: 'Apple Saúde · Garmin · Fitbit · SClínico', badge: 'Novo' },
  ...
  student: [
    {
      ...
      tools: [
        ...
        { href: '/osce',       label: 'Simulação OSCE',      sub: 'AI como doente · feedback imediato' },
  ...
  caregiver: [
    {
      ...
      tools: [
        ...
        { href: '/timeline',        label: 'Histórico de Saúde',   sub: 'Evolução clínica do familiar ao longo do tempo' },
      ],
    },
    {
      id: 'caregiver-safety',
    ...
    },
    {
      ...
      tools: [
        ...
        { href: '/integracoes',  label: 'Importar Dados',         sub: 'Apple Saúde · Garmin · Fitbit · MySNS', badge: 'Novo' },
  ...
  personal: [
    ...
    },
    {
      ...
      tools: [
        ...
        { href: '/prescription', label: 'Perceber a Receita',   sub: 'Foto ou texto → explicação em linguagem simples' },
      ],
    },
  ],
}
