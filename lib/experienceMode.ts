  ...
  clinical: [
    ...
    },
    {
      ...
      tools: [
        ...
        { href: '/oracle',        label: 'Phlox Oracle',              sub: 'Consulta farmacêutica estruturada · SOAP · PCNE', badge: 'Novo' },
        { href: '/optimizer',     label: 'Otimizador de Prescrição',  sub: 'Genéricos · segurança · monitorização · doses', badge: 'Novo' },
        { href: '/food-drug',     label: 'Interações Fármaco-Alimento', sub: 'Toranja · álcool · vitamina K · tiramina', badge: 'Novo' },
  ...
  student: [
    {
      ...
      color: '#7c3aed',
      tools: [
        { href: '/arena',       label: 'Phlox Arena',          sub: 'Ligas Bronze → Diamante · casos AI' },
        { href: '/osce',        label: 'Phlox OSCE',           sub: 'Simulação de OSCE · AI como doente' },
  ...
  caregiver: [
    {
      ...
      tools: [
        ...
        { href: '/consult-prep',      label: 'Preparar Consulta',        sub: 'Briefing AI · perguntas certas · imprimir' },
    ...
    },
    {
      ...
      color: '#374151',
      tools: [
        { href: '/oracle',        label: 'Phlox Oracle',              sub: 'Consulta estruturada com plano de ação', badge: 'Novo' },
        { href: '/passport',     label: 'Passaporte de Saúde',       sub: 'Documento imprimível · QR · PT/EN', badge: 'Novo' },
        { href: '/food-drug',    label: 'Fármaco-Alimento',          sub: 'Álcool · toranja · laticínios · vitamina K', badge: 'Novo' },
  ...
  personal: [
    {
      ...
      tools: [
        ...
        { href: '/vitals',        label: 'Sinais Vitais',               sub: 'TA · FC · SpO₂ · tendências · correlações', badge: 'Novo' },
        { href: '/passport',      label: 'Passaporte de Saúde',         sub: 'Documento imprimível · QR · bilingue', badge: 'Novo' },
        { href: '/plano',         label: 'Care Plan',                   sub: 'O meu guia personalizado' },
        { href: '/consult-prep',   label: 'Preparar Consulta',           sub: 'Briefing AI · perguntas · imprimir' },
    ...
    },
    {
      ...
      tools: [
        { href: '/oracle',        label: 'Phlox Oracle',              sub: 'Consulta estruturada com plano de ação', badge: 'Novo' },
        { href: '/optimizer',    label: 'Otimizar Prescrição',        sub: 'Genéricos · segurança · poupança', badge: 'Novo' },
        { href: '/vitals',       label: 'Sinais Vitais',              sub: 'TA · FC · SpO₂ · peso · glicemia', badge: 'Novo' },
        { href: '/passport',     label: 'Passaporte de Saúde',        sub: 'Documento imprimível · QR · bilingue', badge: 'Novo' },
        { href: '/food-drug',    label: 'Fármaco-Alimento',           sub: 'O que posso comer com a minha medicação?', badge: 'Novo' },
