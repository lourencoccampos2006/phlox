...
export const ROUTE_GROUPS: Record<ExperienceMode, RouteGroup[]> = {
  ...
  clinical: [
    ...
    },
    {
      ...
      color: '#7c3aed',
      tools: [
        { href: '/calculos',      label: 'Calculadoras',              sub: 'CrCl · eGFR · doses · escalas (CHA₂DS₂, qSOFA, NEWS2…)' },
  ...
  student: [
    {
      ...
      tools: [
        ...
        { href: '/exam',          label: 'Simulação de exame',       sub: 'Timer · formato nacional · análise de erros' },
    ...
    },
    {
      ...
      tools: [
        ...
        { href: '/calculos',      label: 'Calculadoras',             sub: 'CrCl · eGFR · doses · escalas clínicas' },
