  ...
  clinical: [
    {
      ...
      color: '#1d4ed8',
      tools: [
        { href: '/consulta',     label: 'Phlox Consulta',           sub: 'Copiloto de consulta · briefing para médico', badge: 'Novo' },
        { href: '/connect',      label: 'Phlox Connect',            sub: 'Comunicação clínica inter-profissional', badge: 'Novo' },
        { href: '/patients',     label: 'Doentes / Utentes',        sub: 'Gestão completa com alertas' },
        { href: '/teams',        label: 'Phlox Teams',               sub: 'Espaço de trabalho clínico em equipa', badge: 'Pro' },
        { href: '/teams',        label: 'Phlox Ward',                sub: 'Ficha clínica colaborativa multi-user', badge: 'Pro' },
        { href: '/connect',      label: 'Phlox Connect',             sub: 'Comunicação clínica inter-profissional', badge: 'Novo' },
        ...
        { href: '/plano',          label: 'Phlox Care Plan',            sub: 'Plano de cuidado farmacológico completo', badge: 'Pro' },
    ...
    },
    {
      ...
      tools: [
        ...
        { href: '/timeline',      label: 'Phlox Timeline',          sub: 'História clínica · correlações IA', badge: 'Novo' },
  ...
  student: [
    {
      ...
      color: '#7c3aed',
      tools: [
        { href: '/arena',    label: 'Phlox Arena',           sub: 'Competição de casos clínicos · ranking global', badge: 'Novo' },
        ...
        { href: '/hive',     label: 'Phlox Hive',           sub: 'Inteligência colectiva · trending', badge: 'Novo' },
        { href: '/osces',    label: 'Phlox OSCEs',          sub: 'Simulação de OSCE com doente AI', badge: 'Novo' },
  ...
  caregiver: [
    {
      ...
      color: '#b45309',
      tools: [
        { href: '/consulta',     label: 'Phlox Consulta',           sub: 'Preparar consulta · briefing para médico', badge: 'Novo' },
        { href: '/perfis',       label: 'Perfis Familiares',        sub: 'Medicação de cada familiar' },
        { href: '/adherencia',    label: 'Monitor de Adesão',        sub: 'Adesão do familiar · padrões' },
    ...
    },
    {
      ...
      tools: [
        ...
        { href: '/plano',         label: 'Phlox Care Plan',          sub: 'Guia completo de cuidado farmacológico', badge: 'Novo' },
        ...
        { href: '/timeline',        label: 'Phlox Timeline',         sub: 'História clínica de cada familiar', badge: 'Novo' },
      ],
    },
  ],
  ...
  personal: [
    {
      ...
      color: '#0d6e42',
      tools: [
        { href: '/plano',        label: 'Phlox Care Plan',         sub: 'O meu guia personalizado de medicação', badge: 'Novo' },
        { href: '/mymeds',       label: 'Os Meus Medicamentos',    sub: 'Lista pessoal com interações' },
        { href: '/adherencia',    label: 'Monitor de Adesão',       sub: 'Registo de tomas · padrões · insights' },
