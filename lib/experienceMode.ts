...
// ─── Menus por modo — máx 8 tools por coluna, sem duplicados ─────────────────
// Critério de inclusão: ferramenta com utilidade real diária para aquele público

export const ROUTE_GROUPS: Record<ExperienceMode, RouteGroup[]> = {

  // ── Clínico: foco no trabalho diário em equipa ────────────────────────────
  clinical: [
    {
      id: 'clinical-work',
      ...
      tools: [
        ...
        { href: '/plano',          label: 'Care Plan',                sub: 'Plano farmacológico imprimível' },
    ...
    },
    {
      ...
      tools: [
        ...
        { href: '/quickcheck',    label: 'Análise Rápida',            sub: 'Lista → risco em segundos' },
        { href: '/monitor',       label: 'Phlox Watcher',             sub: 'Alertas FDA · EMA · INFARMED' },
        { href: '/timeline',      label: 'Timeline',                  sub: 'História clínica · correlações IA' },
      ],
    },
  ],

  // ── Student: foco em estudo, competição e preparação de exames ───────────
  student: [
    {
      id: 'student-compete',
    ...
    },
    {
      ...
      tools: [
        ...
        { href: '/interactions', label: 'Interações',       sub: 'Com explicação do mecanismo', badge: 'Grátis' },
        { href: '/monograph', label: 'Monografia',          sub: 'Qualquer fármaco completo' },
      ],
    },
  ],

  // ── Cuidador: foco em simplicidade e gestão da família ───────────────────
  caregiver: [
    {
      id: 'caregiver-core',
  ...
  // ── Pessoal: foco no utilizador e na sua própria saúde ───────────────────
  personal: [
    {
      id: 'personal-core',
