...
export const PLANS: PlanDef[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'Revisão da tua medicação com o motor de regras clínicas dos profissionais, em português simples',
      'Relatório mensal da tua saúde, com PDF para levar ao médico',
      'Gere um perfil de família a dois — outra pessoa edita medicação e regista sinais, sem pagar',
      'O teu registo de saúde completo em PDF, ou por QR para o médico',
