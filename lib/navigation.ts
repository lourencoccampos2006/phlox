...
export const NAV_CATEGORIES: NavCategory[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      { href: '/medico-bolso', icon: '🩺', label: 'O que merece atenção', desc: 'O Phlox avisa-o quando algo precisa de cuidado' },
  ...
  },
  {
    ...
    tools: [
      { href: '/aprender',  icon: '📖', label: 'Aprender (tudo)',  desc: 'Catálogo de estudo + o teu progresso e áreas fracas' },
